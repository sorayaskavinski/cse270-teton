...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("soso")
    self.driver.find_element(By.ID, "password").send_keys("cool")
  ...
  def test_joinPage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("soraya")
    self.driver.find_element(By.NAME, "lname").send_keys("skavinski")
    self.driver.find_element(By.NAME, "bizname").send_keys("skavinskisteel")
